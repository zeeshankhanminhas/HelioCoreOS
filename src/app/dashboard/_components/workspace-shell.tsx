...
const navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/projects", label: "Projects", mark: "04" },
  ...
  },
  {
    label: "Delivery",
    items: [
      { href: "/dashboard/engineering", label: "Engineering", mark: "06" },
      { href: "/dashboard/procurement", label: "Procurement", mark: "07" },
      { href: "/dashboard/installation", label: "Installation", mark: "08" },
      { href: "/dashboard/quality", label: "Quality", mark: "09" },
      { href: "/dashboard/commissioning", label: "Commissioning", mark: "10" },
      { href: "/dashboard/handover", label: "Handover", mark: "11" },
    ],
  },
  {
    label: "Control",
    ...
    <nav className="space-y-7" aria-label="Primary navigation">
      {navigation.map((group) => (
        <section key={group.label}>
          <p className="mb-2 px-3 text-[10px] font-semibold uppercase tracking-[0.2em] text-[var(--muted)]">
            {group.label}
          </p>
