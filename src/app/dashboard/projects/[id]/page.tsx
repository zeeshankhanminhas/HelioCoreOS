...
import { RecordWorkspaceNav } from "@/components/heliocore/record-workspace";
...
export default async function ProjectWorkspacePage({ params, searchParams }: Props) {
  ...
  const workspaceNav = [
    ...
    { label: "Approved Engineering", href: `/dashboard/designs?project=${id}` },
    { label: "Procurement", href: `/dashboard/requisitions?project=${id}` },
    { label: "Logistics", href: `/dashboard/shipments?project=${id}` },
    { label: "Construction", href: `/dashboard/construction?project=${id}` },
    { label: "HSE & Quality", href: `/dashboard/quality?project=${id}` },
    { label: "Commissioning", href: `/dashboard/commissioning?project=${id}` },
    { label: "Handover", href: `/dashboard/handover?project=${id}` },
  ...
  return (
    <div className="mx-auto max-w-[1500px]">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            <div className="flex items-center gap-3">
              ...
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[var(--accent)]">Project 360 · {project.reference}</p>
            </div>
      ...
      <RecordWorkspaceNav items={workspaceNav} ariaLabel="Project workspace" />
      ...
      <section id="overview" className="mt-7 scroll-mt-28 grid gap-px border border-[var(--line)] bg-[var(--line)] sm:grid-cols-2 xl:grid-cols-5">
        {[
      ...
      <section className="mt-7 grid gap-7 xl:grid-cols-[minmax(0,1.35fr)_minmax(330px,0.65fr)]">
        <div className="space-y-7">
          ...
          <article id="actions" className="scroll-mt-28 border border-[var(--line)]">
          ...
          <article id="documents" className="scroll-mt-28 border border-[var(--line)]">
        ...
        <aside className="space-y-7">
          ...
          <article id="activity" className="scroll-mt-28 border border-[var(--line)]">
