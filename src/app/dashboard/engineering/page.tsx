  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <header className="border-b border-[var(--line)] pb-7">
        <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[var(--accent)]">Pre-contract engineering</p>
      ...
      <section className="mt-7 border border-[var(--line)]">
        <div className="flex items-end justify-between gap-4 border-b border-[var(--line)] p-5 md:px-6">
          <div><p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[var(--muted)]">Engineering register</p><h2 className="mt-2 text-2xl font-medium tracking-[-0.03em]">Active pre-contract engineering</h2></div>
        ...
        ) : <div className="px-6 py-12 text-sm text-[var(--muted)]">No engineering intakes have been created yet.</div>}
      </section>
    </div>
  );
}
